...
from generator_critic_agent.agent import MAX_REFINEMENTS
from generator_critic_agent.agent import root_agent
from generator_critic_agent.agents.critic import critic_agent
from generator_critic_agent.agents.generator import generator_agent
from generator_critic_agent.agents.refiner import refiner_agent
...
async def _run_agent(text: str) -> list[Event]:
  app_name = "generator_critic_test"
  user_id = "test_user"
...
class GeneratorCriticAgentTest(unittest.IsolatedAsyncioTestCase):
